...
function BookingSlots() {
  ...
  const removeCompany = async () => {
    if (applicantId) {
      ...
      const response = await axios.patch("/api/slots/slotDuplicate", data);
  ...
  const applicants = async () => {
    console.log("kkkkkk");
    const req = await axios.get("/api/slots/getApplications");
  ...
  const slotBooking = async (id) => {
    ...
    await axios.post("/api/slots/slotUpdate", data);
    displaySlots();
  };
