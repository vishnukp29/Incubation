...
const viewApplication = async () => {
    let appDetails = await axios.get(`/api/adminHome/viewDetails/${id[0]}`);
            ...
            <Card.Body>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <Card.Text className="text-primary">
                  {app.valuePropsitionForCustomer}
                  </Card.Text>
                </div>
              </div>
              <br></br>
              ...
              <div className="col-md-6" style={{}}>
                ...
                <Card.Text className="text-primary">{app.typeOfIncubation}</Card.Text>
              </div>
              {app.slotCode!=="null" ? (
                <div className="col-md-6" style={{}}>
                  {/* <Card.Title>Slot Code:</Card.Title> */}
                  <Card.Text className="text-primary" >{app.slotCode}</Card.Text>
                </div>
              ) : (
                " "
              )}
